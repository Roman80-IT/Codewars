...
//* - шаблон, який визначає набір символів, які співпадають з будь-якими буквами у верхньому та нижньому регістрах.
...
//?    Math.pow()
// var x = 5;
// var square = Math.pow(x, 2);    // 25
//?    оператор **
// var square = x ** 2;
//! ================================================================================================
//* Вираз Math.sqrt(sq) % 1 перевіряє, чи остача від ділення квадратного кореня числа sq на 1 не дорівнює нулю
//?    Number.isInteger(n);
//! ================================================================================================
//* Метод Math.round() використовується для округлення числа до найближчого цілого значення
// Math.round(3.2) // 3,   (десяткова частина менша за 0.5)
// Math.round(3.8) // 4,   (десяткова частина більша або рівна 0.5)
